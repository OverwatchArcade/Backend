...
namespace OverwatchArcade.Persistence.Migrations
{
    ...
    [Migration("20220628210240_RemovedGameType")]
    partial class RemovedGameType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Config", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            JsonValue = "[{\"Key\":\"e992ded4-30ca-4cdd-9047-d7f0a5ab6378\",\"Value\":0}]",
                            Key = "V1ContributionCount"
                        },
                        new
                        {
                            Id = 3,
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Contributor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Overwatch.ArcadeMode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Overwatch.Daily", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("MarkedOverwrite")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Overwatch.Label", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Overwatch.TileMode", b =>
                {
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Whitelist", b =>
                {
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Overwatch.Daily", b =>
                {
                    b.HasOne("OverwatchArcade.Domain.Models.Contributor", "Contributor")
                        .WithMany()
            ...
            modelBuilder.Entity("OverwatchArcade.Domain.Models.Overwatch.TileMode", b =>
                {
                    b.HasOne("OverwatchArcade.Domain.Models.Overwatch.ArcadeMode", "ArcadeMode")
                        .WithMany()
                        .HasForeignKey("ArcadeModeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OverwatchArcade.Domain.Models.Overwatch.Daily", null)
                        .WithMany("TileModes")
                        .HasForeignKey("DailyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OverwatchArcade.Domain.Models.Overwatch.Label", "Label")
                        .WithMany()
